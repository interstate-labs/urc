...
contract InclusionPreconfSlasherTest is UnitTestHelper, PreconfStructs {
        ...
        )
    {
        ...
        vm.roll(inclusionBlockNumber - getFraudProofWindow());
        vm.warp(inclusionBlockNumber - getFraudProofWindow() * 12);
    ...
    function test_slash() public {
        ...
        bytes32 slashingDigest = keccak256(abi.encode(result.signedDelegation, signedCommitment, result.registrationRoot));
